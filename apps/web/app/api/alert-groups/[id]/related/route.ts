...
export async function GET(
    ...
    try {
        const res = await fetch(`${API_BASE}/api/alert-groups/${id}/related`, {
            method: 'GET',
            headers: {
        ...
        if (!res.ok) {
            ...
            console.error('Related alerts API error:', res.status, errorText);
            try {
        ...
        console.error('Related alerts fetch error:', err);
